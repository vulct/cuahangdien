            ...
            <div class="container-fluid">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">{!! __('Edit :resource',['resource' => 'thông tin phương thức vận chuyển']) !!} {!! __('<span class="text-muted">(Vui lòng điền các trường có chứa dấu <span class="text-danger">*</span>)</span>') !!}</h3>
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" class="form-control" value="{{$shipping->name}}" name="name" required>
                                            </div>
                                            <div class="form-group">
