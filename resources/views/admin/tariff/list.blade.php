                                ...
                                <table id="example1" class="table table-bordered dt-responsive" style="table-layout: fixed;width: 100%;">
                                    ...
                                    @foreach($tariffs as $key => $tariff)
                                        <tr>
                                            ...
                                            <td>{!! \App\Helpers\Helper::active($tariff->active) !!}</td>
                                            <td>
                                                <a class="btn btn-info btn-sm btn-edit" href="{{route('admin.tariffs.edit', $tariff->slug)}}"><i class="fas fa-pencil-alt"></i></a>
                                                <button class="btn btn-danger btn-sm btn-delete" data-url="tariffs/destroy" onclick="removeFunction('{{$tariff->slug}}')"><i class="fas fa-trash"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
