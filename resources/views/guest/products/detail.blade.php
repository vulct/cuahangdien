    ...
    <main class="site-main">
        <div id="shopify-section-static-product" class="shopify-section product--section">
            ...
            @if(isset($product->attributes) && count($product->attributes) > 0)
                @php $price = $product['attributes'][0]['price'] - ($product['attributes'][0]['price']*$product['attributes'][0]['discount']/100); @endphp
            @elseif($product->attributes[0]->price == 0 || $product->attributes[0]->price == "")
                @php $price = 0; @endphp
            @else
                @php $price = $product->attributes[0]->price; @endphp
            @endif
            <script type="application/json" data-section-type="static-product" data-section-id="static-product"
                    data-section-data="">
                            {"recently_viewed_info": {
                                                "title": "{{$product->name}}",
                                                "handle": "{{$product->slug}}",
                                                "image": "{{asset($image)}}",
                                                "price": "<div class='product--price'><div class= 'price--compare-at' data-price-compare-at> <span class='money'></span> </div> <div class='price--main' data-price> <span class='money'>{{number_format($price)}} VND</span></div></div>",
                                                "link": "{{route('products.detail',$product->slug)}}"
                                            },
                                            "time": {
                                                "second": "giây",
                                                "seconds": "giây",
            ...
            <nav class="breadcrumbs-container" role="navigation" aria-label="breadcrumbs" itemscope
                ...
                <div itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    <a href="{{route('hang.danhmuc',[$product->brand->slug, $product->category->slug])}}"
                       itemprop="item">
                        ...
                        <div class="splide">
                            <div class="splide__track">
                                <ul class="splide__list">
                                    ...
                                    @endphp
                                    <li class="splide__slide"><img src="{{asset($image_01)}}"
                                                                   data-src="{{asset($image_01)}}" data-image=""
                                                                   alt="{{$product->name}}" class="lazy" width="800"
                                                                   height="800"></li>
                                    <li class="splide__slide"><img src="{{asset($image_02)}}"
                                                                   data-src="{{asset($image_02)}}" data-image=""
                                                                   alt="{{$product->name}}" class="lazy" width="800"
                                                                   height="800"></li>
                                    <li class="splide__slide"><img src="{{asset($image_03)}}"
                                                                   data-src="{{asset($image_03)}}" data-image=""
                                                                   alt="{{$product->name}}" class="lazy" width="800"
                                                                   height="800"></li>
                                </ul>
                            </div>
                    ...
                    <div class="product-infomation">
                        ...
                        <div class="product-main" data-product-details>
                            <div class="product-details">
                                        ...
                                        @if(isset($product->attributes) && count($product->attributes) > 0)
                                            ...
                                            @if($product->attributes[0]->price)
                                                <div itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                                    ...
                                                    <meta itemprop="price"
                                                          content="{{$product->attributes[0]->price}}"/>
                                            ...
                                            @if($product->attributes[0]->discount > 0 && $product->attributes[0]->price > 0)
                                                ...
                                                <span class="productitem--badge badge--ck" data-badge-sales="">-<span
                                                        data-price-percent-saved="">{{round($product['attributes'][0]['discount'],2)}}</span>%</span>
                                            @elseif($product->attributes[0]->price == 0 || $product->attributes[0]->price == "")
                                                <div class="price--main" data-price="">
                                ...
                                <div style="font-style: italic;color: #d31d1d;font-size: 14.5px;margin-bottom: 6px;">Giá
                                    sản phẩm rẻ hơn khi mua số lượng nhiều
                                    @if( isset($info->zalo) && !empty($info->zalo))
                                        <i style="font-size:14.5px;color:#222;display:block;">(vui lòng thêm vào báo giá
                                            để nhận báo giá hoặc qua zalo: {{$info->zalo}})</i>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="unco">
                                    <div class="row">
                                        <ul class="product--topinfo">
                                            <li><i>Mã sản phẩm:</i> <b
                                                    data-code="">{{$product->attributes[0]->codename ?? "#"}}</b></li>
                                            <li><i>Thương hiệu:</i><a
                                                    href="{{route('hang.danhmuc',[$product->brand->slug,$product->category->slug])}}"
                                                    class="_1line">{{$product->category->name}}
                                                    ({{$product->brand->name}})</a></li>
                                            <li><i>Bảo hành:</i> <b>{{$product->warranty}}</b></li>
                                            <li><i>Loại:</i> <a
                                                    href="{{route('danhmuc.chitiet', $product->category->slug)}}">{{$product->category->name}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="small-12 columns">
                                <div>
                                    <div class="product-price--table">
                                        <a href="{{ isset($tariff) ? route('bang-gia.chitiet',[$tariff->slug, $tariff->id]) : '#' }}"
                                           target="_blank"><i></i>Xem Bảng Giá {{$product->brand->name}} {{date("Y")}}
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div data-product-form-area="">
                                @if($product->attributes->count() > 1)
                                    <div class="notification">
                                        <p class="messa">Sản phẩm có nhiều loại/mẫu, vui lòng chọn để thêm vào bảng giá.
                                            <span style="color: #fff;text-decoration: underline;cursor:pointer"
                                                  onclick="gotolist();">Hoặc xem giá bên dưới.</span></p>
                                ...
                                <form method="post" action="{{route('cart.store')}}" id="add-cart" data-product-form="">
                                                ...
                                                <div class="form-field-select-wrapper">
                                                    <select id="attribute_id" name="attribute_id"
                                                        ...
                                                        @foreach($product->attributes as $key => $attribute)
                                                            <option
                                                                value="{{$attribute->id}}" {!! $key === 0 ? 'selected="selected"' : '' !!}>{{ !empty($attribute->type_name) ? $attribute->type_name : $attribute->codename }}
                                                                -- {{ number_format($attribute->price) }} VND
                                                            </option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    @else
                                        <input type="hidden" id="attribute_id" name="attribute_id"
                                               value="{{$product->attributes[0]->id ?? ""}}">
                                    @endif
                                    <div class="product-form--atc">
                                        <div class="product-form--atc-qty form-fields--qty" data-quantity-wrapper>
                                            <div class="form-field form-field--qty-select visible">
                                                <div class="form-field-select-wrapper">
                                                    <select class="form-field-input form-field-select"
                                                            name="num_product" id="num_product" aria-label="Số lượng"
                                    ...
                                    <div class="box-feeship">
                                        ...
                                        <p>Xem <a
                                                href="{{isset($page['buy_product']) ? route('pages.chitiet',$page['buy_product']->slug) : '#'}}"><i>Hướng
                                                    dẫn mua hàng</i></a> hoặc <a
                                                href="{{isset($page['warranty']) ? route('pages.chitiet', $page['warranty']->slug) : '#'}}"><i>Bảo
                                                    hành &amp; đổi trả</i></a></p>
                                                ...
                                                <div class="links">
                                                    <div class="avatar">
                                                        <img src="{{asset($staff->image)}}"
                                                             data-src="{{asset($staff->image)}}" alt="#"
                                                             style="width: 28px;border-radius: 50%;" class="loaded"
                                                             width="24" height="24">
                                                    </div>
                                                    <a href="tel:{{$staff->phone}}"
                                                       title="Bấm để Gọi tư vấn"> {{$staff->phone}}</a>
                                                    <a class="zalo" href="https://zalo.me/{{$staff->phone}}"
                                                       title="Bấm để Chát tư vấn" target="_blank"> Chat Zalo</a>
                                                </div>
                                            @endif
                                        @endforeach
                            ...
                            @if($product->attributes->count() > 1)
                                <div class="product--description" id="lists">
                                    <div class="product--description-content">
                                            ...
                                            <table>
                                                ...
                                                @foreach($product->attributes as $att)
                                                    ...
                                                    <tr>
                                                        <td width="30">{{$i}}</td>
                                                        <td class="table--img">
                                                            <img src="{{asset($image)}}" data-src="{{asset($image)}}"
                                        ...
                                        <p class="description-notification">Thông tin sản phẩm được cập nhật ngày
                                            <span>{{date('d/m/Y', strtotime($product->updated_at))}}</span>. Nếu GIÁ
                                            hoặc CHIẾC KHẤU có thể chưa được cập nhật mới, Quý khách hàng có nhu cầu vui
                                            lòng liên hệ báo giá qua zalo <a href="tel:{{$info->zalo}}"
                                                                             style="color: orangered;font-weight:500">{{$info->zalo}}</a>
                                            để nhận thông tin giá chính xác nhất. Cảm ơn. </p>
                                    </div>
                                </div>
                            @endif
                            <div class="clear-fix"></div>
            ...
            <section class="product-section--container product-row--container related-products--container"
                ...
                <div class="product-section--heading">
                    <h2 class="product-section--title related-products--title">
                        <a href="{{route('hang.danhmuc',[$product->brand->slug, $product->category->slug])}}">{{$product->category->name}}</a>
                    </h2>
                    <span class="right-view-more"><a
                            href="{{route('hang.danhmuc',[$product->brand->slug, $product->category->slug])}}">Xem thêm »</a></span>
                </div>
                    ...
                    <div class="product-row--outer">
                        <div id="otherRelates">
                            <div class="product-row--inner">
                                @foreach($products_in_category as $same_product)
                                    @php $image = $same_product->image ?? $same_product->image_01 ?? $same_product->image_02 @endphp
                                    <article class='productgrid--item imagestyle--natural productitem--emphasis'
                                             data-product-item
                                             tabindex='1'>
                                        <div class='productitem' data-product-item-content>
                                            <a class='productitem--image-link'
                                               href='{{route('products.detail',$same_product->slug)}}'>
                                                <figure class='productitem--image' data-product-item-image>
                                                    <img alt='{{$same_product->name}}'
                                                         src='{{asset($image)}}' width='350' height='350'>
                                                </figure>
                                            </a>
                                            <div class='productitem--info'>
                                                <div class='productitem--price'>
                                                    @if(isset($same_product['attributes']) && count($same_product['attributes']) > 0)
                                                        @if($same_product['attributes'][0]['discount'] > 0 && $same_product->attributes[0]->price > 0)
                                                            <div class='price--compare-at visible'
                                                                 data-price-compare-at>
                                                                <span class='price--spacer'>{{number_format($same_product['attributes'][0]['price'])}} VND</span>
                                                            </div>
                                                            <span class='productitem--badge badge--sale'
                                                                  data-badge-sales>
                                                    <span data-price-percent-saved>{{round($same_product['attributes'][0]['discount'],2)}}
                                                    </span>%
                                                </span>

                                                            <div class='price--main' data-price>
                                                    <span class='money'>
                                                        {{number_format($same_product['attributes'][0]['price'] - ($same_product['attributes'][0]['price']*$same_product['attributes'][0]['discount']/100))}} <span>VND</span>
                                                    </span>
                                                            </div>
                                                        @elseif($same_product->attributes[0]->price == 0 || $same_product->attributes[0]->price == "")
                                                            <div class="price--compare-at visible"
                                                                 data-price-compare-at="">
                                                        ...
                                                        <span data-price-percent-saved>Liên Hệ</span>
                                                            ...
                                                            <div class='price--main' data-price>
                                                        <span class='money'>
                                                            {{number_format($same_product['attributes'][0]['price'])}} <span>VND</span>
                                                        </span>
                                                            </div>
                                                        @endif
                                                    @endif
                                                ...
                                                <h4 class='productitem--title'>
                                                    <a href='{{route('products.detail',$same_product->slug)}}'>
                                                        {{$same_product->name}}
                                                    </a>
                                                </h4>
                                                @php
                                                    $description = \App\Helpers\Helper::clearDescriptionProduct($same_product->description);
                                                @endphp
                                                ...
                                                <div class='productitem--provider'><img
                                                        src='{{asset($brands[$same_product->brand_id]->image)}}'
                                                        alt='{{$brands[$same_product->brand_id]->name}}' width='120'
                                                        height='60'></div>
                                            </div>
                                        </div>
                                    </article>
                        ...
                        <div class="spr-container">
                            <div class="spr-header">
                                ...
                                <div class="spr-summary">
                                    <span class="spr-summary-caption">Chưa có đánh giá nào</span><span
                                        class="spr-summary-actions">
                                        <a href='javascript:void(0)' class='spr-summary-actions-newreview'
                                           id='newreview'>Viết đánh giá</a>
                                    </span>
                                </div>
                            </div>
                                    ...
                                    <form method="get" action="#" id="new-review-form" class="new-review-form">
                                        ...
                                        <fieldset class="spr-form-contact">
                                            <div class="spr-form-contact-name">
                                                ...
                                                <input class="spr-form-input spr-form-input-text " id="review_author"
                                            ...
                                            <div class="spr-form-review-email">
                                                ...
                                                <input class="spr-form-input spr-form-input-text " id="email"
                                                       type="text" name="email" value="" placeholder="Email của bạn">
                                            </div>
                                            ...
                                            <div class="spr-form-review-body">
                                                ...
                                                <div class="spr-form-input">
                                                    <textarea class="spr-form-input spr-form-input-textarea"
                                                              id="message" data-product-id="#" name="content" rows="10"
            ...
            <section class="product-section--container product-recently-viewed--section">
                <div class="product-recently-viewed-wrapper">
                    ...
                    <div class="product-section--content product-recently-viewed--content imagestyle--natural"
